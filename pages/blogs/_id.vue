                    ...
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div :class="dropDownMenu ? 'absolute':'hidden'" class="z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-52 right-2 top-12">
                          <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                              <a href="https://twitter.com/intent/tweet?dato=https://sebastianmorales.co/blogs/2">
                            ...
                            <li>
                              <a href="https://www.instagram.com/create/details/?url=https://sebastianmorales.co/blogs/2">
                                <p class="flex text-left px-4 py-2 hover:bg-gray-100 cursor-pointer gap-3">
