      ...
      <div class="flex xs:flex-col flex-nowrap w-full xs:px-4 md:px-20 py-8">
              ...
              <header>
                <section class="py-8">
                  <div class="px-4 w-full flex flex-col gap-5 text-left">
                    ...
                    <h2 class=" text-2xl font-extrabold leading-none text-[#374151] sm:text-3xl lg:text-4xl">
                      {{ blog?.attributes?.title }}
                    </h2>
                  </div>
                </section>
                <div
                  class="flex flex-col lg:flex-row justify-between lg:items-center py-6 border-t border-b border-black">
                  <article class="flex gap-3">
                    <span class="text-base mb-4 lg:mb-0 font-normal text-gray-500">By <a
                        href="#" rel="author"
                        class="font-bold text-gray-900 no-underline hover:underline">{{ blog?.attributes?.author?.data?.attributes?.name }}</a>
                    </span>
                    <span>
                    ...
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div :class="dropDownMenu ? 'absolute':'hidden'" class="z-50 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-52 right-2 top-12">
                          <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                              <a href="https://twitter.com/intent/tweet?url=https://sebastianmorales.co/blogs/2&text=Blog">
                                <p class="text-left px-4 py-2 hover:bg-gray-100 cursor-pointer flex gap-3">
                                  <svg
                                  class="w-4 h-4" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 512 512">
                                    <path
                            ...
                            <li>
                              <a href="https://www.facebook.com/sharer/sharer.php?u=https://sebastianmorales.co/blogs/2">
                                <p class="flex text-left px-4 py-2 hover:bg-gray-100 cursor-pointer gap-3">
                            ...
                            <li>
                              <a href="https://www.instagram.com/share?url=https://sebastianmorales.co/blogs/2">
                                <p class="flex text-left px-4 py-2 hover:bg-gray-100 cursor-pointer gap-3">
                  ...
                  <!-- <aside aria-label="Share social media">
                    <a href="#"
                      class="inline-flex items-center py-2 px-6 mr-2 text-xs font-medium text-gray-900 no-underline bg-white rounded-lg border border-gray-200 focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"><svg
                    ...
                    <button type="button"
                      class="inline-flex items-center py-2 px-6 text-xs font-medium text-gray-900 no-underline bg-white rounded-lg border border-gray-200 focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"><svg
                        class="mr-2 w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                  ...
                  <article class="p-6 mb-6 text-base bg-gray-50 h-auto rounded-lg">
                    <footer class="flex justify-between items-center mb-2 relative">
                      ...
                      <button
                        ...
                        class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-400 bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                        type="button">
                        <svg
              ...
              <div class="sticky top-6">
                ...
                <div v-if="!isAuthenticated" class="p-4 mb-6 rounded-lg border border-gray-200 bg-white">
                  ...
                  <p class="mb-4 text-sm font-light text-gray-500">Get all the stories you need-to-know
                    from the most powerful name in news delivered first thing every morning to your inbox</p>
                  <form action="#">
                    <label for="name-address-icon" class="sr-only">Your Name</label>
                    <div class="relative mb-4">
                      ...
                      <input
                        ...
                        placeholder="Sebastian Morales" required>
                    </div>
                    <label for="email-address-icon" class="sr-only">Your Name</label>
                    <div class="relative mb-4">
                      <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                        <svg
                      ...
                      <input
                        id="email-address-icon"  v-model="email" type="text"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5"
                    ...
                    <div class="mb-6 text-left border-b pb-3">
                      <span class="flex items-center justify-between mb-4">
                        <p class="inline-flex items-center mr-3 text-sm text-gray-900"><img
                            ...
                            alt="Michael Gough">
                          {{ element?.attributes?.author?.data?.attributes?.name }}
                        </p>
                        <p class="text-sm text-gray-600">Hace {{ getDate(element?.attributes?.createdAt) }} dias</p>
                      </span>
                      <h5 class="mb-2 text-lg font-bold leading-tight text-gray-900">{{ element?.attributes?.title }}</h5>
                      <p class="mb-2 font-light text-gray-500">
                        {{ element?.attributes?.description }}
                      </p>
                      <footer class="flex flex-row justify-start gap-5 my-3 text-gray-500">
                        <span class="flex flex-row gap-3 items-center">
                          <svg
                            width="16" height="13" viewBox="0 0 16 13" fill="text-gray-500"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                              fill-rule="evenodd" clip-rule="evenodd"
                              d="M1.85481 1.56388C2.52991 0.888985 3.44542 0.50985 4.40001 0.50985C5.3546 0.50985 6.27011 0.888985 6.94521 1.56388L8.00001 2.61778L9.05481 1.56388C9.3869 1.22004 9.78414 0.945788 10.2234 0.757116C10.6626 0.568444 11.135 0.469133 11.613 0.46498C12.091 0.460826 12.565 0.551912 13.0074 0.732923C13.4499 0.913935 13.8518 1.18125 14.1898 1.51926C14.5278 1.85727 14.7952 2.25922 14.9762 2.70165C15.1572 3.14407 15.2483 3.61812 15.2441 4.09613C15.24 4.57413 15.1406 5.04652 14.952 5.48574C14.7633 5.92495 14.489 6.32219 14.1452 6.65428L8.00001 12.8004L1.85481 6.65428C1.17992 5.97918 0.800781 5.06367 0.800781 4.10908C0.800781 3.15449 1.17992 2.23898 1.85481 1.56388Z"
                          ...
                          {{ element?.attributes?.likes }} reactions
                        </span>
                        <span class="flex flex-row gap-3 items-center">
                          <svg
                            width="16" height="15" viewBox="0 0 16 15" fill="text-gray-500"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                              fill-rule="evenodd" clip-rule="evenodd"
                              d="M15.2 9.60913V2.40913C15.2 1.93174 15.0103 1.4739 14.6728 1.13634C14.3352 0.798773 13.8774 0.609131 13.4 0.609131H2.59999C2.1226 0.609131 1.66476 0.798773 1.3272 1.13634C0.98963 1.4739 0.799988 1.93174 0.799988 2.40913V9.60913C0.799988 10.0865 0.98963 10.5444 1.3272 10.8819C1.66476 11.2195 2.1226 11.4091 2.59999 11.4091H5.29999L7.99999 14.1091L10.7 11.4091H13.4C13.8774 11.4091 14.3352 11.2195 14.6728 10.8819C15.0103 10.5444 15.2 10.0865 15.2 9.60913ZM3.49999 4.20913C3.49999 3.97044 3.59481 3.74152 3.76359 3.57274C3.93237 3.40395 4.16129 3.30913 4.39999 3.30913H11.6C11.8387 3.30913 12.0676 3.40395 12.2364 3.57274C12.4052 3.74152 12.5 3.97044 12.5 4.20913C12.5 4.44783 12.4052 4.67674 12.2364 4.84553C12.0676 5.01431 11.8387 5.10913 11.6 5.10913H4.39999C4.16129 5.10913 3.93237 5.01431 3.76359 4.84553C3.59481 4.67674 3.49999 4.44783 3.49999 4.20913ZM4.39999 6.90913C4.16129 6.90913 3.93237 7.00395 3.76359 7.17274C3.59481 7.34152 3.49999 7.57044 3.49999 7.80913C3.49999 8.04783 3.59481 8.27674 3.76359 8.44553C3.93237 8.61431 4.16129 8.70913 4.39999 8.70913H7.09999C7.33868 8.70913 7.5676 8.61431 7.73638 8.44553C7.90517 8.27674 7.99999 8.04783 7.99999 7.80913C7.99999 7.57044 7.90517 7.34152 7.73638 7.17274C7.5676 7.00395 7.33868 6.90913 7.09999 6.90913H4.39999Z"
                          ...
                          {{ element?.attributes?.comentaries?.data?.length }} commits
                        </span>
                      </footer>
                      <p>
                        <nuxt-link :to="'/blogs/'+element.id" class="gap-2 inline-flex items-center font-medium text-[#0088B2]">
                          Read More <Arrow-Icon :color="'#0088B2'"/>
                        </nuxt-link>
                      </p>
                    </div>
                  </article>
        ...
        <aside aria-label="Related articles" class="py-8 lg:py-24">
          <div class="px-4 mx-auto max-w-screen-xl">
            <h2 class="mb-8 text-2xl font-bold text-gray-900">Read next</h2>
            <section class="grid grid-cols-3 gap-x-8 gap-y-8">
              <article  v-for="(element,index) in blogs" :key="index" class="flex mb-8">
                <div class="mb-6 text-left">
                  <span class="flex items-center justify-between mb-4">
                    <img
                      class="rounded-lg"
                      :src="'https://api.sebastianmorales.co'+element?.attributes?.image?.data?.attributes?.url" alt="">
                  </span>
                  <h2 class="mb-2 text-lg font-bold leading-tight text-gray-900">
                    {{ element?.attributes?.title }}
                  </h2>
                  <nuxt-link :to="'/blogs/'+element?.id">
                    <p
                      class="mb-2 inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500">
                      Leer Mas
                    </p>
                  </nuxt-link>
                </div>
...
export default {
  ...
  computed: {
    ...
    blogs() {
      return this.$store.state.allBlogs.filter(obj => obj.id !== this.$store.state.blog.id);
    },
    content() {
  ...
  watch:{
    commentary(){
      this.verifyCommentary();
    },
    blog() {
      this.blogComment = this.blog;
    },
    name() {
      this.information();
    },
  ...
  methods: {
    ...
    async submit(){
      ...
      const endpoint = 'https://api.sebastianmorales.co/api/comentaries';
      await this.$axios
        .post(endpoint, body)
        .then((response) => {
    ...
    const endpoint = 'https://api.sebastianmorales.co/api/formularies';
    await this.$axios
      .post(endpoint, body)
      .then((response) => {
        if (response.status === 200) {
    ...
    information(){
      if (this.email && this.name && this.emailValue) {
...
// https://api.sebastianmorales.co/api/blogs/1?populate[0]=image&populate[1]=author&populate[2]=author.image
</script>
