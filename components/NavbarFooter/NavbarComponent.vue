    ...
    <nav class="bg-[#0088B2] fixed xs:rounded-2xl md:rounded-3xl w-[98%] 2xl:w-[1440px] z-50 mt-3 shadow-lg">
      <div class="flex flex-wrap items-center justify-between mx-auto px-8 py-2">
        ...
        <button data-collapse-toggle="navbar-dropdown" type="button"
          ...
          aria-controls="navbar-dropdown" aria-expanded="false" @click="openNavbar">
          <!-- <span class="sr-only">Open main menu</span> -->
          <svg class="w-12 h-12 pr-3" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div id="navbar-dropdown" class="hidden w-full md:block md:w-auto">
          <ul class="flex flex-col font-medium bg-[#0088B2] text-lg md:flex-row md:py-5 lg:p-5 gap-5">
...
export default {
  ...
  methods: {
    openNavbar() {
      document.querySelector('#navbar-dropdown').classList.toggle('hidden');
      this.nav = !this.nav;
    }
  }
};
